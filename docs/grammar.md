...
function_declaration ->
    "fn" identifier = "(" (identifier | identifier ",")* ")" ":" type "=>"
    scoped_variables => expression ";"
...
factor -> unary ( ( "/" | "*" ) unary )*
unary -> ( "!" | "-" ) unary | primary
primary -> number | string | "true" | "false" | "nil" | "(" expression ")" | identifier | function_call | pattern_matching
